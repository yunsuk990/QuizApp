              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text('당신의 점수는', style: TextStyle(fontSize: width*0.048, fontWeight: FontWeight.bold),),

                        Expanded(child: Container()),

                        Text(score.toString() + '/' + quizs.length.toString(), style: TextStyle(fontSize: width*0.21, fontWeight: FontWeight.bold, color: Colors.red),),
                  ...
                  Container(
                    ...
                    child: ButtonTheme(
                      minWidth: width*0.73, height: height*0.05,
